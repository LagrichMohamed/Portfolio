    ...
    <>
      <nav className=' mb-20 flex  items-center justify-between py-6'>
        ...
        <div className="m-8 flex items-center justify-center gap-4 text-2xl">
            ...
            <div className=""><button onClick={scrollToContact} className="p-4 bg-black rounded-2xl hover:bg-purple-700 transition-colors text-sm">Contact Me</button></div>
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-black p-6 rounded-lg">
            ...
            <div className="flex justify-around">
              ...
              <a href="https://drive.google.com/uc?export=download&id=1ZqculBiwy997-2kIu0AgFJCODWyWQS_b" target="_blank" rel="noopener noreferrer" className="p-2 bg-blue-500 m-5 text-white rounded">Download CV (English)</a>
            </div>
